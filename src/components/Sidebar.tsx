...
const Sidebar: React.FC<SidebarProps> = ({
  ...
  const selectedModelObj = indianEVModels.find(model => model.id === selectedEVModel) || indianEVModels[0];
  
  // Calculate remaining range based on battery percentage
  const remainingRange = selectedModelObj ? Math.round((selectedModelObj.range * batteryPercentage) / 100) : 0;
      ...
      <div className="p-4 flex flex-col">
        ...
        {hasRouteInfo && (
          <div className="mt-8 border-t pt-4">
            ...
            {/* Journey plan inside the sidebar */}
            {evStations.length > 0 && (
              <div className="mt-6">
                <RouteJourney
                  ...
                  selectedEVModel={selectedModelObj}
